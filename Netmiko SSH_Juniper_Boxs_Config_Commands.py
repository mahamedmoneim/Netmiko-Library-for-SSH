...
"""
# This is SSH code by Netmiko Library, can be run from windows or Linux machines to add configuration to Juniper device
...
#below you should create txt file contain commands you will add to juniper box line by line, but this commands file in desktop , python path or in the same path of code
...
with open('devices_file') as IPsfile:
